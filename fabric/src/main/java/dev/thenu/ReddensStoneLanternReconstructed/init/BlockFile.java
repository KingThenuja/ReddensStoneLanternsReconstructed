...
public class BlockFile {
    ...
    public static Block THIN_STONE_LANTERN_TOP_DARK = registerBlock("thin_stone_lantern_top_dark", AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).sounds(BlockSoundGroup.STONE).strength(1.0F, 10.0F).nonOpaque().pistonBehavior(PistonBehavior.NORMAL).solidBlock((state, world, pos) -> false), ThinStoneLanternBlockDarkBlock::new);
