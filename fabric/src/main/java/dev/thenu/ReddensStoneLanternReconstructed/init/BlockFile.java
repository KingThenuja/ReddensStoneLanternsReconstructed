...
public class BlockFile {
    ...
    public static Block BIG_STONE_LANTERN_BASE           = registerBlock("big_stone_lantern_base",           properties -> new BigStoneLanternBaseBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).noOcclusion().pushReaction(PushReaction.NORMAL).forceSolidOff()));
    ...
    public static Block BIG_STONE_LANTERN_TOP_LIGHT      = registerBlock("big_stone_lantern_top_light",      properties -> new BigStoneLanternTopLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((s) -> 15).noOcclusion().pushReaction(PushReaction.NORMAL).forceSolidOff()));
    ...
    public static Block BIGGER_STONE_LANTERN_BLOCK_D     = registerBlock("bigger_stone_lantern_block_d",     properties -> new BiggerStoneLanternBlockDBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).noOcclusion().pushReaction(PushReaction.DESTROY).forceSolidOff()));
    public static Block BIGGER_STONE_LANTERN_BLOCK_L     = registerBlock("bigger_stone_lantern_block_l",     properties -> new BiggerStoneLanternBlockLBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY).forceSolidOff()));
    ...
    public static Block BIG_STONE_LANTERN_BLOCK_LIGHT    = registerBlock("big_stone_lantern_block_light",    properties -> new BigStoneLanternBlockLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((s) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY).forceSolidOff()));
    ...
    public static Block MEDIUM_STONE_LANTERN             = registerBlock("medium_stone_lantern",             properties -> new MediumStoneLanternBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).noOcclusion().pushReaction(PushReaction.BLOCK).forceSolidOff()));
    ...
    public static Block MEDIUM_STONE_LANTERN_TOP_LIGHT   = registerBlock("medium_stone_lantern_top_light",   properties -> new MediumStoneLanternTopLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.BLOCK).forceSolidOff()));
    ...
    public static Block SMALL_STONE_LANTERN_LIGHT        = registerBlock("small_stone_lantern_light",        properties -> new SmallStoneLanternLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 14).noOcclusion().pushReaction(PushReaction.DESTROY).dynamicShape().forceSolidOff()));
    public static Block SMALL_STONE_LANTERN_DARK         = registerBlock("small_stone_lantern_dark",         properties -> new SmallStoneLanternDarkBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).noOcclusion().pushReaction(PushReaction.DESTROY).dynamicShape().forceSolidOff()));
    ...
    public static Block MINI_STONE_LANTERN_LIGHT         = registerBlock("mini_stone_lantern_light",         properties -> new MiniStoneLanternLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 13).noOcclusion().pushReaction(PushReaction.DESTROY).forceSolidOff()));
    ...
    public static Block SMALLFOOT_STONE_LANTERN_LIGHT    = registerBlock("smallfoot_stone_lantern_light",    properties -> new SmallfootStoneLanternLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 14).noOcclusion().pushReaction(PushReaction.DESTROY).forceSolidOff()));
    ...
    public static Block THIN_STONE_LANTERN_TOP_LIGHT     = registerBlock("thin_stone_lantern_top_light",     properties -> new ThinStoneLanternTopLightBlock(properties
            .mapColor(MapColor.STONE).sound(copyOf(SoundType.STONE)).strength(1.0F, 10.0F).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.NORMAL).forceSolidOff()));
