...
public class StonePillarThinCTickProcedure {
    ...
    public static void execute(WorldAccess world, double x, double y, double z) {
        ...
        if (bottomIsPillar) {
            if (topIsPillar) {
                bs = BlockFile.STONE_PILLAR_THIN_C_MIDDLE.getDefaultState();
            } else {
                bs = BlockFile.STONE_PILLAR_THIN_C_TOP.getDefaultState();
            }
        } else if (topIsPillar) {
            bs = BlockFile.STONE_PILLAR_THIN_C_BOTTOM.getDefaultState();
        } else {
            bs = BlockFile.STONE_PILLAR_THIN_C_SHORT.getDefaultState();
        }
