...
public class MidStoneLanternBlockRightClickProcedure {
    ...
    public static void execute(WorldAccess world, double x, double y, double z) {
        ...
        if (bso.getBlock() == BlockFile.MID_STONE_LANTERN_BLOCK_LIGHT) {
            bs = BlockFile.MID_STONE_LANTERN_BLOCK_DARK.getDefaultState();
        } else {
            bs = BlockFile.MID_STONE_LANTERN_BLOCK_LIGHT.getDefaultState();
        }
        ...
        // Sound cues handled cleanly across both logical sides
