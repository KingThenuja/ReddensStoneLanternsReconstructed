...
public class SmallfootRightClickProcedure {
    ...
    public static void execute(WorldAccess world, double x, double y, double z) {
        ...
        if (bso.getBlock() == BlockFile.SMALLFOOT_STONE_LANTERN_LIGHT) {
            bs = BlockFile.SMALLFOOT_STONE_LANTERN_DARK.getDefaultState();
        } else {
            bs = BlockFile.SMALLFOOT_STONE_LANTERN_LIGHT.getDefaultState();
        }
