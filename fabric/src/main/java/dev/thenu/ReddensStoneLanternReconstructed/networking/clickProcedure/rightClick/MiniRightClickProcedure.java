...
public class MiniRightClickProcedure {
    ...
    public static void execute(WorldAccess world, double x, double y, double z) {
        ...
        if (bso.getBlock() == BlockFile.MINI_STONE_LANTERN_DARK) {
            bs = BlockFile.MINI_STONE_LANTERN_LIGHT.getDefaultState();
        } else {
            bs = BlockFile.MINI_STONE_LANTERN_DARK.getDefaultState();
        }

        // Copy block state values across dynamically
        ...
        // Replicate flint and steel audio signals on both sides
