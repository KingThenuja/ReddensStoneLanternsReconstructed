...
public class SmallStoneLanternLightBlock extends Block implements Waterloggable {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return VoxelShapes.union(
                ...
                Block.createCuboidShape(4.5D, 14.0D, 4.5D, 11.5D, 15.0D, 11.5D),
                Block.createCuboidShape(3.0D, 12.0D, 3.0D, 13.0D, 14.0D, 13.0D),
                Block.createCuboidShape(7.0D, 15.0D, 7.0D, 9.0D, 16.0D, 9.0D)
        );
    }
